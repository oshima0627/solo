...
export default function RulesPage() {
  return (
    <main className="flex min-h-dvh flex-col gap-6 p-4 pb-10">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-bold text-coral-400">バクダンが出たら山札を入れ替える</h2>
        <div className="space-y-3 text-sm leading-relaxed text-foam-300">
          <p>
            ソロは1色20枚で遊びますが、その色は固定ではありません。
            <strong className="text-gold-400">バクダン（10のペア）が出たら、♠♣の山札と♥♦の山札を持ち替えます。</strong>
            次にまたバクダンが出れば、元の色に戻ります。
          </p>
          <p>
            どちらの色でもA〜10が2枚ずつという構成は同じなので、
            <strong>確率にも役の強さにも一切影響しません。</strong>
            大きく場が動いた区切りを目に見える形で示す作法のようなものです。
          </p>
          <p className="text-foam-500">
